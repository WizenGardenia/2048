================================================================================
    MICROSOFT 基础类库 : 2048 项目概述
===============================================================================

应用程序向导已为您创建了此 2048 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
res\2048.ico
    这是用作应用程序图标的图标文件。此图标包括在主资源文件 2048.rc 中。
...
2048Dlg.h、2048Dlg.cpp - 对话框
    这些文件包含 CMy2048Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 2048.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 2048.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
